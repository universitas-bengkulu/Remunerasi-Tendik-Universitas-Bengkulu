                    ...
                    @if ($message = Session::get('success'))
                        ...
                        @elseif ($message = Session::get('error'))
                            ...
                            <div class="alert alert-success alert-block" id="keterangan">
                                <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Berikut semua Jabatan yang tersedia, data berikut didapatkan dari Sistem Informasi administrator (SIMPEG), silahkan tambahkan manual jika diperlukan !!
                            </div>
                    @endif
                </div>
                <div class="col-md-12" id="form-jabatan">
                    <hr style="width:50%;">
                    <form action="{{ route('administrator.jabatan.post') }}" method="POST">
                     ...
                     <div class="modal fade" id="modalubah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action=" {{ route('administrator.jabatan.update') }} " method="POST">
...
@push('scripts')
    <script>
        ...
        function editJabatan(id){
            $.ajax({
                url: "{{ url('administrator/jabatan') }}"+'/'+ id + "/edit",
                type: "GET",
                dataType: "JSON",
