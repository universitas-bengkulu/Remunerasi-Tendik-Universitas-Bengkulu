...
@section('content')
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <div class="col-md-12 form-tambah" id="form-tambah" style="display:none;">
                    <hr style="width:50%;">
                    <form action="{{ route('administrator.tendik.post') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label>Jenis administrator :</label>
                                <input type="text" name="jenis_administrator" value="{{ old('jenis_administrator') }}" class="form-control  @error('jenis_administrator') is-invalid @enderror" placeholder=" masukan jenis administrator">
                                @error('jenis_administrator')
                                    <small class="form-text text-danger">{{ $errors->first('jenis_administrator') }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                    ...
                    <div class="modal fade" id="modalubah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <form action="{{ route('administrator.tendik.update') }}" method="POST">
                                <div class="modal-body">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>Jenis administrator :</label>
                                            <input type="text" name="jenis_administrator" id="jenis_administrator" required class="form-control" placeholder=" masukan jenis administrator">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label>Jenis Kelamin :</label>
            ...
            <div class="modal fade" id="modalgeneratepassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action=" {{ route('administrator.tendik.generate_password') }} " method="POST">
                            {{ csrf_field() }} {{ method_field('POST') }}
                            <div class="modal-header">
        ...
        <div class="modal fade" id="modalubahpassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action=" {{ route('administrator.tendik.ubah_password') }} " method="POST">
                        {{ csrf_field() }} {{ method_field('PATCH') }}
                        <div class="modal-header">
...
@push('scripts')
    <script>
        ...
        function ubahTendik(id){
            $.ajax({
                url: "{{ url('administrator/manajemen_data_tendik') }}"+'/'+ id + "/edit",
                type: "GET",
                dataType: "JSON",
                success: function(data){
                    ...
                    $('#jenis_administrator').val(data.jenis_administrator)
