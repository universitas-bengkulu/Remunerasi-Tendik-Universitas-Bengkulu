...
@section('content')
    ...
    <section class="panel" style="margin-bottom:20px;">
        ...
        <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
            ...
            <div class="col-md-12">
                <a onclick="tambahunit()" class="btn btn-primary btn-sm" style="color:white; cursor:pointer;"><i class="fa fa-user-plus"></i>&nbsp; Tambah Unit</a>
            </div>
           <div class="row">
                           ...
                           @foreach ($units as $unit)
                               <tr>
                                   ...
                                   <td style="text-align:center;">
                                    <a href="{{ route('administrator.unit.update',[$unit->id]) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
        ...
        <div class="modal fade" id="modaltambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action=" {{ route('administrator.unit.add') }} " method="POST">
                    {{ csrf_field() }} {{ method_field('POST') }}
                    <div class="modal-header">
                        <p style="font-size:15px; font-weight:bold;" class="modal-title"><i class="fa fa-clock-o"></i>&nbsp;Form Tambah Data unit</p>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="" >Nama unit  <a style="color:red"></a></label>
                                    <input type="text" name="nm_unit" value="{{ old('nm_unit') }}" class="form-control @error('nm_unit') is-invalid @enderror" placeholder="nama unit">
                                    <div>
...
<script>
    ...
    //         }
    //     });
    //     url = "{{ url('administrator/unit/aktifkan_status').'/' }}"+id;
    //     $.ajax({
    //         url : url,
    //         type : 'PATCH',
    ...
    //         }
    //     });
    //     url = "{{ url('administrator/unit/non_aktifkan_status').'/' }}"+id;
    //     $.ajax({
    //         url : url,
    //         type : 'PATCH',
    //         success : function($data){
