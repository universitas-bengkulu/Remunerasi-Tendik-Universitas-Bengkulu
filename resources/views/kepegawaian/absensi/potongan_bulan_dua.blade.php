            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                    ...
                    @if ($message = Session::get('success'))
                        ...
                        @elseif ($message = Session::get('error'))
                            ...
                            @else
                                @if ($a == "sudah")
                                    <div class="alert alert-success alert-block">
                                        <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Nominal potongan bulan 2  <b style="text-transform:uppercase">{{ $periode_aktif->nm_periode }}</b> sudah digenerate !!
                                    </div>
                                    @else
                                    <div class="alert alert-danger alert-block">
                                        <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Silahkan Generate Potongan absensi Bulan Dua Terlebih Dahulu !!
                                    </div>
                                @endif
                    @endif
                </div>
                <div class="col-md-12">
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link" href="{{ route('kepegawaian.r_absensi.potongan_bulan_1',[$periode_id]) }}">Previous</a>
                              </li>
                ...
                <div class="col-md-12">
                    @if ($a == "sudah")
                        <button class="btn btn-primary btn-sm disabled"><i class="fa fa-cog fa-spin"></i>&nbsp; Generate Nominal Potongan Bulan Dua</button>
                        @else
                        <a href="{{ route('kepegawaian.r_absensi.generate_potongan_bulan_dua',[$periode_id]) }}" onclick="geneerateTendik()" class="btn btn-primary btn-sm"><i class="fa fa-cog fa-spin"></i>&nbsp; Generate Nominal Potongan Bulan Dua</a>
                    @endif
                </div>
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover" id="table" style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">Persentase Potongan Bulan Dua</th>
                                <th style="text-align:center">Nominal Potongan Bulan Dua</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        {{ $data->potongan_bulan_2 }}%
                                    </td>
                                    <td style="text-align:center;">
                                        Rp.{{ number_format($data->nominal_bulan_2) }},-
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
