                ...
                <div class="col-md-12">
                    @if ($message = Session::get('success'))
                        ...
                        @elseif ($message = Session::get('error'))
                            ...
                            @if ($a == "sudah")
                                <div class="alert alert-success alert-block">
                                    <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Nominal potongan bulan 6  <b style="text-transform:uppercase">{{ $periode_aktif->nm_periode }}</b> sudah digenerate !!
                                </div>
                                @else
                                <div class="alert alert-danger alert-block">
                                    <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Silahkan Generate Potongan absensi Bulan Enam Terlebih Dahulu !!
                                </div>
                            @endif
                    @endif
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        {{ $data->potongan_bulan_6 }}%
                                    </td>
                                    <td style="text-align:center;">
                                        Rp.{{ number_format($data->nominal_bulan_6) }},-
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
