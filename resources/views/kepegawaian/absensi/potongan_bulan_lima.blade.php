            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                <div class="col-md-12">
                    @if ($message = Session::get('success'))
                        ...
                        @elseif ($message = Session::get('error'))
                            ...
                            @if ($a == "sudah")
                                <div class="alert alert-success alert-block">
                                    <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Nominal potongan bulan 5  <b style="text-transform:uppercase">{{ $periode_aktif->nm_periode }}</b> sudah digenerate !!
                                </div>
                                @else
                                <div class="alert alert-danger alert-block">
                                    <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Silahkan Generate Potongan absensi Bulan Lima Terlebih Dahulu !!
                                </div>
                            @endif
                    @endif
                </div>
                <div class="col-md-12">
                    <nav aria-label="...">
                        <ul class="pagination">
                          ...
                          <li class="page-item"><a class="page-link" href="{{ route('kepegawaian.r_absensi.potongan_bulan_4',[$periode_id]) }}">5</a></li>
                          ...
                          @if ($periode_aktif->jumlah_bulan == "6")
                                <li class="page-item"><a class="page-link" href="{{ route('kepegawaian.r_absensi.potongan_bulan_6',[$periode_id]) }}">7</a></li>
                          @endif
                ...
                <div class="col-md-12">
                    @if ($a == "sudah")
                        ...
                        @else
                        <a href="{{ route('kepegawaian.r_absensi.generate_potongan_bulan_lima',[$periode_id]) }}" onclick="geneerateTendik()" class="btn btn-primary btn-sm"><i class="fa fa-cog fa-spin"></i>&nbsp; Generate Nominal Potongan Bulan Lima</a>
                    @endif
                </div>
                <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover" id="table" style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">Persentase Potongan Bulan Lima</th>
                                <th style="text-align:center">Nominal Potongan Bulan Lima</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        {{ $data->potongan_bulan_5 }}%
                                    </td>
                                    <td style="text-align:center;">
                                        Rp.{{ number_format($data->nominal_bulan_5) }},-
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
