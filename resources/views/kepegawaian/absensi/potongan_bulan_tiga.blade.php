            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                    ...
                    @if ($message = Session::get('success'))
                        ...
                        @elseif ($message = Session::get('error'))
                            ...
                            @else
                                @if ($a == "sudah")
                                    <div class="alert alert-success alert-block">
                                        <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Nominal potongan bulan 3  <b style="text-transform:uppercase">{{ $periode_aktif->nm_periode }}</b> sudah digenerate !!
                                    </div>
                                    @else
                                    <div class="alert alert-danger alert-block">
                                        <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian: </strong> Silahkan Generate Potongan absensi Bulan Tiga Terlebih Dahulu !!
                                    </div>
                                @endif
                    @endif
                </div>
                <div class="col-md-12">
                    <nav aria-label="...">
                        <ul class="pagination">
                          ...
                          @endif
                          <li class="page-item">
                            <a class="page-link" href="{{ route('kepegawaian.r_absensi.potongan_bulan_4',[$periode_id]) }}">Next</a>
                          </li>
                        </ul>
                    </nav>
                </div>
                <div class="col-md-12">
                    @if ($a == "sudah")
                        ...
                        @else
                        <a href="{{ route('kepegawaian.r_absensi.generate_potongan_bulan_tiga',[$periode_id]) }}" onclick="geneerateTendik()" class="btn btn-primary btn-sm"><i class="fa fa-cog fa-spin"></i>&nbsp; Generate Nominal Potongan Bulan Tiga</a>
                    @endif
                </div>
                <div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        {{ $data->potongan_bulan_3 }}%
                                    </td>
                                    <td style="text-align:center;">
                                        Rp.{{ number_format($data->nominal_bulan_3) }},-
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
