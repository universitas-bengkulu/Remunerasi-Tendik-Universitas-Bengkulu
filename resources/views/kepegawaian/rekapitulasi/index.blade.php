...
@section('content')
    <section class="panel" style="margin-bottom:20px;">
        <header class="panel-heading" style="color: #ffffff;background-color: #074071;border-color: #fff000;border-image: none;border-style: solid solid none;border-width: 4px 0px 0;border-radius: 0;font-size: 14px;font-weight: 700;padding: 15px;">
            <i class="fa fa-home"></i>&nbsp;Generate Table Rekapitulasi
        </header>
            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <div class="col-md-12" >
                    <nav aria-label="...">
                        <ul class="pagination">
                          ...
                          <li class="page-item disabled"><a class="page-link" href="{{ route('kepegawaian.rekapitulasi.total_remun',[$periode_id]) }}">3</a></li>
                          ...
                          <li class="page-item">
                            <a class="page-link" href="{{ route('kepegawaian.rekapitulasi.data_tendik',[$periode_id]) }}">Next</a>
                          </li>
                        </ul>
                    </nav>
                </div>
                <div class="col-md-12">
                    @if (Schema::hasTable($table))
                        ...
                        @else
                        <a href="{{ route('kepegawaian.rekapitulasi.generate_table',[$periode_id]) }}" id="generate" onclick="generateTable()" class="btn btn-primary btn-sm"><i class="fa fa-cog fa-spin"></i>&nbsp; Generate Table Rekapitulasi</a>
                    @endif
