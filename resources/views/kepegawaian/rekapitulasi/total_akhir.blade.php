                        ...
                        <tbody>
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td> Rp. {{ number_format(round($data->remunerasi_per_bulan)) }} </td>
                                    <td> Rp. {{ number_format(round($data->remunerasi_30)) }} </td>
                                    <td> Rp. {{ number_format(round($data->remunerasi_70)) }} </td>
                                    <td> {{ $data->jumlah_bulan }} </td>
                                    <td> Rp. {{ number_format(round($data->jumlah_remun_30)) }} </td>
                                    <td> Rp. {{ number_format(round($data->jumlah_remun_70)) }} </td>
                                    <td> Rp. {{ number_format(round($data->total_remun)) }} </td>
                                    <td> Rp. {{ number_format(round($data->potongan_pph)) }} </td>
                                    <td> {{ $data->laporan_lhkpn_lhkasn }} </td>
                                    <td> {{ $data->sanksi_disiplin }} </td>
                                    <td> Rp. {{ number_format(round($data->nominal_lhkpn_lhkasn)) }} </td>
                                    <td> Rp. {{ number_format(round($data->nominal_sanksi_disiplin)) }} </td>
                                    <td> {{ $data->potongan_integritas_satu_bulan }} </td>
                                    <td> {{ $data->nilai_skp }} </td>
                                    <td> {{ $data->potongan_skp }} </td>
                                    @if ($periode_aktif->jumlah_bulan == 1)
                                        <td>{{ $data->persen_absen_bulan_satu }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_satu)) }}</td>
                                        @elseif ($periode_aktif->jumlah_bulan == 2)
                                        <td>{{ $data->persen_absen_bulan_satu }}</td>
                                        <td>{{ $data->persen_absen_bulan_dua }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_satu)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_dua)) }}</td>
                                        @elseif ($periode_aktif->jumlah_bulan == 3)
                                        <td>{{ $data->persen_absen_bulan_satu }}</td>
                                        <td>{{ $data->persen_absen_bulan_dua }}</td>
                                        ...
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_satu)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_dua)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_tiga)) }}</td>
                                        @elseif ($periode_aktif->jumlah_bulan == 4)
                                        <td>{{ $data->persen_absen_bulan_satu }}</td>
                                        <td>{{ $data->persen_absen_bulan_dua }}</td>
                                        <td>{{ $data->persen_absen_bulan_tiga }}</td>
                                        ...
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_dua)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_tiga)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_empat)) }}</td>
                                        @elseif ($periode_aktif->jumlah_bulan == 5)
                                        <td>{{ $data->persen_absen_bulan_satu }}</td>
                                        <td>{{ $data->persen_absen_bulan_dua }}</td>
                                        <td>{{ $data->persen_absen_bulan_tiga }}</td>
                                        ...
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_tiga)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_empat)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_lima)) }}</td>
                                        @elseif ($periode_aktif->jumlah_bulan == 6)
                                        <td>{{ $data->persen_absen_bulan_satu }}</td>
                                        <td>{{ $data->persen_absen_bulan_dua }}</td>
                                        <td>{{ $data->persen_absen_bulan_tiga }}</td>
                                        ...
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_empat)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_lima)) }}</td>
                                        <td>Rp. {{ number_format(round($data->nominal_absen_bulan_enam)) }}</td>
                                    @endif
                                    <td>Rp. {{ number_format(round($data->total_absensi)) }}</td>
                                    <td>Rp. {{ number_format(round($data->total_skp)) }}</td>
                                    <td>Rp. {{ number_format(round($data->total_integritas)) }}</td>
                                    <td>
                                        @if ($data->total_akhir_remun == null)
                                            <a style="color: red">Total belum digenerate</a>
                                            @else
                                            Rp. {{ number_format(round($data->total_akhir_remun)) }}
                                        @endif
                                    </td>
