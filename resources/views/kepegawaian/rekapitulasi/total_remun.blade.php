            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <div class="col-md-12" >
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link" href="{{ route('kepegawaian.rekapitulasi.data_tendik',[$periode_id]) }}">Previous</a>
                            </li>
                          ...
                          <li class="page-item">
                            <a class="page-link" href="{{ route('kepegawaian.rekapitulasi.integritas',[$periode_id],[$periode_id]) }}">Next</a>
                          </li>
                        </ul>
                    </nav>
                </div>
                <div class="col-md-12">
                    @if ($a == "sudah")
                        ...
                        @else
                        <a href="{{ route('kepegawaian.rekapitulasi.generate_total_remun',[$periode_aktif->id]) }}" id="generate" onclick="generateTendik()" class="btn btn-primary btn-sm"><i class="fa fa-cog fa-spin"></i>&nbsp; Generate Total Remunerasi</a>
                    @endif
