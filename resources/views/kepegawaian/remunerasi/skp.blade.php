            ...
            <div class="row" style="margin-right:-15px; margin-left:-15px;">
                ...
                <div class="col-md-12" >
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class="page-item">
                                <a class="page-link" href="{{ route('kepegawaian.remunerasi.integritas',[$periode_id]) }}">Previous</a>
                            </li>
                          ...
                          <li class="page-item"><a class="page-link" href="{{ route('kepegawaian.remunerasi.integritas',[$periode_id]) }}">3</a></li>
                          ...
                          <li class="page-item"><a class="page-link" href="{{ route('kepegawaian.remunerasi.persentase_absen',[$periode_id]) }}">5</a></li>
                ...
                <div class="col-md-12">
                    @if ($a == "sudah")
                        ...
                        @else
                        <a href="{{ route('kepegawaian.remunerasi.generate_skp',[$periode_id]) }}" id="generate" onclick="generateTendik()" class="btn btn-primary btn-sm"><i class="fa fa-cog fa-spin"></i>&nbsp; Generate Rubrik SKP</a>
                    @endif
