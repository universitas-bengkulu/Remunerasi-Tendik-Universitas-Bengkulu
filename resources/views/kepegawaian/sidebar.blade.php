...
<li>
    <a class={{ count($periode_aktif)<1 ? "noclick"  : 'click'}} href=" {{ route('kepegawaian.jabatan') }} "><i class="fa fa-briefcase"></i>Manajemen Jabatan</a>
</li>

<li>
    <a class={{ count($periode_aktif)<1 ? "noclick"  : 'click'}} href=" {{ route('kepegawaian.tendik') }} "><i class="fa fa-users"></i>Manajemen Data Tendik</a>
</li>
...
<li 
    ...
    @endif
><a class={{ count($periode_aktif)<1 ? "noclick"  : 'click'}}><i class="fa fa-check-circle"></i>Rubrik Remun P1&P2<span class="fa fa-chevron-down" ></span></a>
