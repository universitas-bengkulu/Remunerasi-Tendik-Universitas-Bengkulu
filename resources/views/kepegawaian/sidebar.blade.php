...
><a class={{ !empty($periode_aktif) ? "noclick"  : 'click'}}><i class="fa fa-check-circle"></i>Rubrik Remun P1&P2<span class="fa fa-chevron-down" ></span></a>
    ...
    >
        ...
        @if (Route::current()->getName() == "kepegawaian.capaian_skp")
                class="current-page"
        @endif
        ><a href=" {{ route('kepegawaian.r_skp',[!empty($periode_aktif) ? $periode_aktif->id : '']) }} ">Rubrik Capaian SKP</a></li>
        <li
            ...
            class="current-page "
        @endif
        ><a href=" {{ route('kepegawaian.r_absensi',[!empty($periode_aktif) ? $periode_aktif->id : '']) }} ">Rubrik Absensi</a></li> 
        <li
            @if (Route::current()->getName() == "kepegawaian.r_integritas")
                ...
                class="current-page"
            @endif
        ><a href=" {{ route('kepegawaian.r_integritas',[!empty($periode_aktif) ? $periode_aktif->id : '']) }} ">Rubrik Disiplin</a></li> 
    </ul>
</li>

<li>
    <a href=" {{ route('kepegawaian.rekapitulasi',[!empty($periode_aktif) ? $periode_aktif->id : '']) }} "><i class="fa fa-bar-chart"></i>Rekapitulasi P1, P2</a>
</li>
