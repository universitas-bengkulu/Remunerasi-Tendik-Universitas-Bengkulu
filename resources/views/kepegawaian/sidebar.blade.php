...
@endphp
<li>
    <a class={{ $periode_aktif or false ? "noclick"  : 'click'}} href=" {{ route('kepegawaian.dashboard') }} "><i class="fa fa-home"></i>Dashboard</a>
</li>
...
<li>
    <a class={{ $periode_aktif or false ? "noclick"  : 'click'}} href=" {{ route('kepegawaian.jabatan') }} "><i class="fa fa-briefcase"></i>Manajemen Jabatan</a>
</li>

<li>
    <a class={{ $periode_aktif or false  ? "noclick"  : 'click'}} href=" {{ route('kepegawaian.tendik') }} "><i class="fa fa-users"></i>Manajemen Data Tendik</a>
</li>

<li @if (Route::current()->getName() == "kepegawaian.r_integritas" || Route::current()->getName() == "kepegawaian.r_integritas.remun_30"
    ...
    <ul class="nav child_menu" @if (Route::current()->getName() == "kepegawaian.r_integritas" || Route::current()->getName() == "kepegawaian.r_integritas.remun_30"
        ...
        <li @if (Route::current()->getName() == "kepegawaian.r_integritas")
            ...
            class="current-page"
            @endif
            ><a href=" {{ route('kepegawaian.r_integritas',[$periode_aktif or false  ? $periode_aktif->id : '']) }} ">Rubrik Disiplin</a></li>
    </ul>
</li>

<li>
    <a href=" {{ route('kepegawaian.rekapitulasi',[$periode_aktif or false  ? $periode_aktif->id : '']) }} "><i class="fa fa-bar-chart"></i>Rekapitulasi P1, P2</a>
</li>
