...
<section class="panel" style="margin-bottom:20px;">
    ...
    <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
        <div class="row" style="margin-right:-15px; margin-left:-15px;">
            <div class="col-md-12">Selamat datang <strong> </strong> di halaman Dashboard Administrator<b> Sistem Informasi Remunerasi Tenaga Kependidikan Universitas Bengkulu</b></div>
        </div>
    </div>
</section>
    <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="small-box bg-aqua" style="margin-bottom:0px;">
                                ...
                                <h4>
                                    @if (!is_null($periode_aktif))
                                        <b>
                                            {{ $periode_aktif->masa_kinerja }}
                                        </b>
                                    @else
                                    <a style="color: red;">Tidak ada periode aktif</a>
                                    @endif
                                </h4>
                        ...
                        <div class="col-lg-3 col-xs-3 col-md-3" style="padding-bottom:10px !important;">
                            ...
                            <div class="small-box bg-red" style="margin-bottom:0px;">
                                <div class="inner">
                                <h4>
                                    @if (!is_null($jumlah_rubrik))
                                        {{ $jumlah_rubrik->jumlah }}
                                    @else
                                    0
                                    @endif
                                </h4>
                        ...
                        <div class="col-lg-3 col-xs-3 col-md-3" style="padding-bottom:10px !important;">
                            ...
                            <div class="small-box bg-green" style="margin-bottom:0px;">
                                <div class="inner">
                                <h4>
                                    @if (!is_null($total_remun))
                                        Rp.{{ number_format($total_remun->total_remun,2) }}
                                    @else
