                                    ...
                                    <div class="col-md-12" style="margin-bottom:5px;">
                                        @if (empty($about->nm_lengkap) || empty($about->nip) || empty($about->nm_jabatan) || empty($about->kelas_jabatan) || empty($about->golongan) || empty($about->jenis_kelamin) || empty($about->no_rekening) || empty($about->no_npwp))
                                            <div class="alert alert-warning" role="alert">
                                                <strong><i class="fa fa-info-circle"></i>&nbsp;Perhatian</strong> Data anda belum lengkap, harap hubungi bagian kepegawaian / keuangan. Anda tidak dapat mengupload file SKP jika data tidak lengkap
                                            </div>
                                            @else
                                            <div class="alert alert-success" role="alert">
                                                <strong><i class="fa fa-check-circle"></i>&nbsp;Selamat</strong> Data anda sudah lengkap, silahkan hubungi bagian kepegawaian / keuangan jika ada kesalahan data, anda sudah dapat mengupload SKP pada menu Rubrik !!
                                            </div>
                                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xs-12 col-md-12" style="padding-bottom:10px !important;">
                                        <!-- small box -->
